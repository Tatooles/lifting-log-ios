...
The command must execute exactly 3 tests with no failures. Treat a result with fewer than 3 executed tests as partial smoke coverage, not a passing gate.
